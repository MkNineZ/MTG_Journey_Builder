                ...
                <div id="deck-visual-tabletop">
                    <div class="tabletop-header">
                        ...
                        <div class="tabletop-header-stats">
                            <div id="tabletop-mana-curve" class="mana-curve" style="height: 75px; margin: 0; padding: 0; min-height: 75px;"></div>
                            <div id="tabletop-color-dist" style="display: flex; flex-direction: row; gap: 0.5rem; align-items: center; justify-content: flex-end; margin: 0; padding: 0; min-height: 75px;"></div>
                        </div>
                    </div>
